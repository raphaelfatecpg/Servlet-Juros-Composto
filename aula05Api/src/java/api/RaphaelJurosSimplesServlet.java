 ...
 * @author Fatec
 */
@WebServlet(name = "RaphaelJurosSimplesServlet", urlPatterns = {"/raphael-juros-simples.json"})
public class RaphaelJurosSimplesServlet extends HttpServlet {
     ...
     */
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getRequestURI().endsWith("/aula05Api/raphael-juros-simples.json")){
    ...
    protected void processJsonRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("application/json;charset=UTF-8");
                   ...
                   int JS =(capital*taxa* tempo)/100 ;
                        
                  
        JSONObject file = new JSONObject();
      
        
        file.put("Resultado", JS);
